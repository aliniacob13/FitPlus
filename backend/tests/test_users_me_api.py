...
class TestUsersMe:
    ...
    async def test_get_me_returns_profile(self, client: AsyncClient, auth_headers: dict, test_user: User) -> None:
    ...
    async def test_put_me_updates_name(self, client: AsyncClient, auth_headers: dict, test_user: User) -> None:
